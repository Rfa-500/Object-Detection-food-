...
class PortionEstimate:
    """Structured result returned by :class:`PortionEstimator`."""
...
class PortionEstimator:
    """Estimate mass and uncertainty for detections using geometry heuristics."""
    ...
    def estimate(
        ...
        """Estimate the portion size for ``label`` constrained by ``bbox``."""
